...
public class GeografijaDAO {
    ...
    private GeografijaDAO() {
        ...
        try {
            ...
            promijeniDrzavuUpit = conn.prepareStatement("UPDATE drzava SET naziv=?, glavni_grad=?, uredjenje=? WHERE id=?");
    ...
    private Drzava dajDrzavuIzResultSeta(ResultSet rs) throws SQLException {
        Drzava.Uredjenje uredjenje = Drzava.Uredjenje.values()[rs.getInt(4)];
        Drzava d = new Drzava(rs.getInt(1), rs.getString(2), null, uredjenje);
    ...
    public void dodajDrzavu(Drzava drzava) {
        try {
            ...
            dodajDrzavuUpit.setInt(4, drzava.getUredjenje().ordinal());
    ...
    public void izmijeniDrzavu(Drzava drzava) {
        try {
            ...
            promijeniDrzavuUpit.setInt(3, drzava.getUredjenje().ordinal());
